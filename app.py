                        ...
                        for node, updates in s.items():
                            with output_container:
                                ...
                                if "final_verdict" in updates and updates["final_verdict"]:
                                    ...
                                    st.warning("⚠️ **Disclaimer:** This analysis is generated by an AI and not by a human or a SEBI-registered Financial Researcher or Advisor. Please consult a qualified professional before making any investment decisions.")
